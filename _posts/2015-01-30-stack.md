...
<IMG class="img-float-left" SRC="../images/imagingcore/stack_example_spines.jpg" WIDTH="250">
<IMG class="img-float-right" SRC="../images/mm3/mm3-stackdb-example-3.png" WIDTH="450">
...
Once the Z-Projection window is open, it behaves just like a stack window (with only one slice). For example, you can set contrast with keyboard 'c', view a histogram with keyboard 'h', and copy/paste the image to another program.
