...
Single mouse click will **select** an annotation. Selected annotations are highlighted in yellow. Right-click will show context menu for selected annotation.
...
The contrast bar is used to set image contrast in a stack window. Image **contrast** is critical, if contrast is not set properly you may not see dim but potentially important structures in your images.
